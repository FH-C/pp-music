...
const subscribeArtist = (data: object): Promise<SubArtistType.Root> => post(
  '/artist/sub' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistDetail = (data: object): Promise<ArtistDetailType.Root> => post(
  '/artist/detail' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistDesc = (data: object): Promise<ArtistDescType.Root> => post(
...
const getSimilarArtists = (data: object): Promise<SimilarArtistsType.Root> => post(
  '/simi/artist' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistHotSongs = (data: object): Promise<ArtistHotSongsType.Root> => post(
  '/artists' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistAlbum = (data: object): Promise<ArtistHotAlbumsType.Root> => post(
  '/artist/album' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistSongs = (data: object): Promise<ArtistSongsType.Root> => post(
  '/artist/songs' + '?timestamp=' + new Date().getTime(), data, true)

const getArtistVideos = (data: object): Promise<ArtistVideosType.Root> => post(
