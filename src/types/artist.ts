export interface ArtistFollowType {
  code: number
  message: string
  data: Data
}
...
export interface ArtistHotSongsType {
  artist: Artist3
  hotSongs: HotSong[]
  more: boolean
  code: number
...
export interface ArtistHotAlbumsType {
  artist: Artist4
  hotAlbums: HotAlbum[]
  more: boolean
  code: number
...
export interface ArtistSongsType {
  songs: Song[]
  more: boolean
  total: number
  code: number
...
export interface ArtistVideosType {
  code: number
  message: string
  data: Data3
}
...
export interface SubArtistType {
  code: number
  message: string
  data: any
}
